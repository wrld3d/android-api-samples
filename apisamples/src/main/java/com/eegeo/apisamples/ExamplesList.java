...
public final class ExamplesList {
    ...
    public static final ExampleContainer[] Examples = {
            ...
            new ExampleContainer(R.string.query_indoor_map_entity_information_example_label,
                    R.string.query_indoor_map_entity_information_example_description,
                    QueryIndoorMapEntityInformationActivity.class),
            new ExampleContainer(R.string.query_indoor_map_floor_outline_information_example_label,
                    R.string.query_indoor_map_floor_outline_information_example_description,
                    QueryIndoorMapFloorOutlineInformationActivity.class),
            ...
            new ExampleContainer(R.string.indoor_map_loading_notification_label,
                    R.string.indoor_map_loading_notification_description,
                    IndoorMapLoadingNotificationActivity.class),
