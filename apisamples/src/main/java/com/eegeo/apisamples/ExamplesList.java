...
public final class ExamplesList {
    ...
    public static final ExampleContainer[] Examples = {
            ...
            new ExampleContainer(R.string.query_indoor_map_entity_information_and_add_marker_example_label,
                    R.string.query_indoor_map_entity_information_and_add_marker_example_description,
                    QueryIndoorMapEntityInformationAndAddMarkerActivity.class),
