...
public final class ExamplesList {
    ...
    public static final ExampleContainer[] Examples = {
            ...
            new ExampleContainer(R.string.get_interior_highlights_example_label,
                    R.string.get_interior_highlights_example_description,
                    GetInteriorHighlightsActivity.class),
            new ExampleContainer(R.string.query_indoor_entities_example_label,
                    R.string.query_indoor_entities_example_description,
                    QueryIndoorEntityActivity.class),
