...
public class InteractWithHeatmapActivity extends WrldExampleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.interact_with_heatmap_activity);
        m_mapView = (MapView) findViewById(R.id.interact_with_heatmap_mapview);
